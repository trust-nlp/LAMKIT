...
def main():
    ...
    train_dataset = load_dataset('multi_eurlex', 'hr', split="train")
    eval_dataset=load_dataset('multi_eurlex', 'hr', split="validation")
    predict_dataset=load_dataset('multi_eurlex', 'hr', split="test")
